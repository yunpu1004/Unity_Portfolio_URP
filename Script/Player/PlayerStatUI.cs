...
public class PlayerStatUI : MonoBehaviour
{
    ...
    private void Awake() 
    {
        ...
        playerStat.OnHPChangedEvent += (hp, maxHp) => SetMaxHpText(maxHp);
        playerStat.OnAtkChangedEvent += SetAtkText;
        playerStat.OnDefChangedEvent += SetDefText;
        playerStat.OnWeaponChangedEvent += weaponSlot.UpdateSlot;
        playerStat.OnShieldChangedEvent += shieldSlot.UpdateSlot;
