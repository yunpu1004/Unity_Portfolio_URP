...
## 프로젝트 소개
본 포트폴리오는 3D RPG 장르의 게임입니다. 옵저버 패턴을 사용하여 거래, 인벤토리, 스테이터스 등 다양한 UI를 구현하였으며, NPC, 퀘스트, 스킬 등 RPG의 요소들도 구현되어 있습니다. 또한 상태 패턴을 사용하여 몬스터의 행동을 구현했습니다. 자세한 설명은 위에 링크된 유튜브 영상과 소개서를 참고해주시면 감사하겠습니다.   
